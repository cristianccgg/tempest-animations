...
const MidWaterfall2 = () => {
  ...
  return (
    <div className="w-full md:-mt-32 relative overflow-hidden z-10">
      {/* Mobile: exact copy from main (MidWaterfall + Waterfall2) */}
      <div className="md:hidden">
        {/* MidWaterfall exact from main */}
        <div className="w-full h-[500px]">
          <div
            className="w-full h-full bg-no-repeat bg-center bg-[length:170%_100%] flex justify-center items-center"
        ...
        {/* Waterfall2 exact from main */}
        <div className="w-full h-[800px] relative overflow-hidden">
          <div
            className="absolute w-full h-full bg-no-repeat bg-[length:125%_100%]
                       sm:right-[-20%]"
